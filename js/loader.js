...
function clearCacheAndReload() {
    ...
    const newUrl = window.location.origin + window.location.pathname + '?v=' + timestamp;
  ...
  document.getElementById('clearCacheButton').addEventListener('click', clearCacheAndReload);
